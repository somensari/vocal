...
internal object DefaultSeedData {
    ...
    val starterPhrases = listOf(
        ...
        PhraseSeed("Water", "I want water", 0, 3),
        PhraseSeed("Bathroom", "I need the bathroom", 1, 0),
        PhraseSeed("Happy", "I am happy", 1, 1),
        PhraseSeed("Sad", "I am sad", 1, 2),
        PhraseSeed("More", "More please", 1, 3),
        PhraseSeed("Stop", "Stop please", 2, 0),
    )
